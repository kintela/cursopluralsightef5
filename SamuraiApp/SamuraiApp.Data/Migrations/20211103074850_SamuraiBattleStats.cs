    ...
    public partial class SamuraiBattleStats : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
          migrationBuilder.Sql(
            @"CREATE FUNCTION dbo.EarliestBattleFoughtBySamuray(@samuraiId int)
            RETURNS char(30) AS
            BEGIN
	            DECLARE @ret char(30)
	            ...
	            FROM Battles
	            WHERE Battles.BattleId IN(SELECT BattleId FROM BattleSamurai WHERE SamuraiId=@samuraiId)
	            ORDER BY StartDate
          ...
          migrationBuilder.Sql(
              @"CREATE VIEW dbo.SamuraiBattleStats
	              ...
	              SELECT	dbo.Samurais.Name,
			              ...
			              dbo.EarliestBattleFoughtBySamuray(MIN(dbo.Samurais.Id)) as EarliestBattle
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
          ...
          migrationBuilder.Sql("DROP FUNCTION dbo.EarliestBattleFoughtBySamuray");
        }
    }
}
